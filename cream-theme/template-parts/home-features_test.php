...
<section class="home-services-section clearfix">
    ...
    <div class="section-top">
        ...
        <div class="container">
            <div class="row fade-in-up animated fadeInUp" style="opacity: 0;">
                <div class="col-md-6">
                    <h2>Who we are</h2>
                     <p>Based in London, and covering the South East of England, Lucky Cow is a small family run business who always focus on great customer service and THE best possible ingredients</p>
                </div>
                <div class="col-md-6">
                    <h2>What we do</h2>
                    <p>We offer a substantial range of superb quality organic ice cream and cones at extremely competitive prices (see our price guarantee for further details)</p>
                    <p>Because of our size we have a great attention to detail. You can be assured of a truly personalised and bespoke service that will compliment your event beautifully.
                    </p>
